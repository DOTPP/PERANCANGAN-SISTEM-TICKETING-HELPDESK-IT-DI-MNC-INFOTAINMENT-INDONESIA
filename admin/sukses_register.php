            ...
            <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-5">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        ...
                        <li><a class="dropdown-item" href="#!"><?php $departemen ?></a></li>
                    </ul>
                </li>
            </ul>
        </nav>
                                ...
                                <div class="col-md-6 mx-auto col-lg-5 col-sm-12">
                                    <div class="card  mt-5">
                                        <div class="card-body">
                                            ...
                                            <h4 class="text-center">User baru telah tersimpan</h4>
                                            <p class="text-center">Mohon untuk mencoba login kembali</p>
