                                    ...
                                    <div class="card bg-primary text-white mb-4">
                                        <div class="card-body">
                                            ...
                                            <?php
                                                ...
                                                $sql= "select count(teknisi) AS jumlah from tiket where teknisi='$name'";
                                    ...
                                    <div class="card bg-warning text-white mb-4">
                                        <div class="card-body">
                                            ...
                                            <?php
                                                ...
                                                $conn = mysqli_connect($server, $user, $pass, $database);
                                                $sql= "select count(teknisi) AS jumlah from tiket where teknisi='$name' AND status='Diproses oleh Teknisi'";
                                                $query = mysqli_query($conn, $sql);
                                                $result = mysqli_fetch_array($query);
                                                $counting = $result["jumlah"];
                                    ...
                                    <div class="card bg-success text-white mb-4">
                                        <div class="card-body">
                                            ...
                                            <?php
                                                ...
                                                $conn = mysqli_connect($server, $user, $pass, $database);
                                                $sql= "select count(teknisi) AS jumlah from tiket where teknisi='$name' AND status='Selesai Diproses Teknisi'";
                                                $query = mysqli_query($conn, $sql);
                                                $result = mysqli_fetch_array($query);
                                                $counting = $result["jumlah"];
