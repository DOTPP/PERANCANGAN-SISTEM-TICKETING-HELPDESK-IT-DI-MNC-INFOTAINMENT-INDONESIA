                        ...
                        <div class="card-body">
                            <table id="datatablesSimple1">
                                ...
                                <tbody>
                                    ...
                                    $sql= "SELECT * FROM tiket where teknisi='$name'";
                        ...
                        <div class="card-body">
                            <table id="datatablesSimple2">
                                ...
                                <tbody>
                                    ...
                                    $sql= "SELECT * FROM tiket where teknisi='$name'' Menunggu Konfirmasi Admin'";
                                    $query = mysqli_query($conn, $sql);
                        ...
                        <div class="card-body">
                            <table id="datatablesSimple3">
                                ...
                                <tbody>
                                    ...
                                    $sql = "SELECT * FROM tiket where status='Diproses oleh Teknisi'";
                                    $query = mysqli_query($conn, $sql);
...
if (!$conn) {
    die("Gagal terhubung dengan database: " . mysqli_connect_error());
                                    ...
                                    $sql = "SELECT * FROM tiket where status='Selesai Diproses Teknisi'";
                                    $query = mysqli_query($conn, $sql);
...
if (!$conn) {
    die("Gagal terhubung dengan database: " . mysqli_connect_error());
                                    ...
                                    $sql = "SELECT * FROM tiket where status='Ditolak'";
                                    $query = mysqli_query($conn, $sql);
