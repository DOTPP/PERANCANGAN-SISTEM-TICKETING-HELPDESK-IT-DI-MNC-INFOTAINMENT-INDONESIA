                            ...
                            <form action="config/proses_edit.php" method="POST">
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="hidden" name="id_admin" value="<?php echo $id_users ?>" readonly/>
                                    </div>
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <input type="text"  class="form-control" name="asign_to" value="<?php echo $tiket['asign_to'] ?>" />
                                    </div>

                                    
                                    <div class="mb-3 col-md-6">
                                        <label class="form-label">Pilih Teknisi</label>
                                        <select  class="form-select" aria-label="Default select example" name="teknisi" id="teknisi">
                                            <option disabled selected> Pilih </option>
                                            <option value="Tidak Ada Teknisi"> Tidak Ada Teknisi </option>
                                            <?php 
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <input type="text" class="form-control"  name="subject" value="<?php echo $tiket['subject'] ?>" />
                                    </div>
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <select class="form-select" aria-label="Default select example" name="status">
                                            ...
                                            <option value="Diproses oleh Admin">Diproses oleh Admin</option>
                                            <option value="Diteruskan kepada Teknisi">Diteruskan kepada Teknisi</option>
