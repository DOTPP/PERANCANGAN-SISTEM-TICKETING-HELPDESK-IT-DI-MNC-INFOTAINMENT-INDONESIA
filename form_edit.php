                            ...
                            <form action="config/proses_edit.php" method="POST">
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <input type="text"  class="form-control"  name="status" value="<?php echo $tiket['status'] ?>"  readonly/>
                                    </div>
     
                                    <div class="mb-3 col-md-12">
                                        <label class="form-label"> Update</label>
                                        <textarea class="form-control"  name="update" value="<?php echo $tiket['update'] ?>"></textarea>
                                    </div>
